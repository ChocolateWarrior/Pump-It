...
public class UpdateProfileViewModelFactory extends ViewModelProvider.NewInstanceFactory {
    private UserRepository repository;

    public UpdateProfileViewModelFactory(final UserRepository repository) {
    ...
    public <T extends ViewModel> T create(@NonNull Class<T> modelClass) {
        return (T) new UpdateProfileViewModel(repository);
    }
}
